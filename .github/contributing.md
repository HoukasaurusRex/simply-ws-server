# Contributing to simply-ws-server

First and foremost, thank you! We appreciate that you want to contribute to simply-ws-server, your time is valuable, and your contributions mean a lot to us.
...
**Showing support for simply-ws-server**

Please keep in mind that open source software is built by people like you, who spend their free time creating things the rest the community can use.

Don't have time to contribute? No worries, here are some other ways to show your support for simply-ws-server:

- star the [project](https://github.com/Pterobyte/simply-ws-server)
- tweet your support for simply-ws-server
...
- **version**: (required) please note the version of simply-ws-server are you using
...
The original poster or the maintainers of simply-ws-server may close an issue at any time. Typically, but not exclusively, issues are closed when:
...
[so]: http://stackoverflow.com/questions/tagged/simply-ws-server
